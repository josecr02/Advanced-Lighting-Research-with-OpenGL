...
int main()
{
    ...
    Shader cubeShader("3.3.shader.vs", "3.3.shader.fs");
    ...
    // world space positions of our cubes. This is for spawing the cubes (not used)
    ...
    unsigned int diffuseMap = loadTexture("C:/Users/josec/Desktop/2024 Projects/C&C++/Breakout/resources/dirt2.jpg");
    unsigned int specularMap = loadTexture("C:/Users/josec/Desktop/2024 Projects/C&C++/Breakout/resources/container2_specular.png");
    ...
    // load and create a texture. Not being used currently!
    // -------------------------
    ...
    //unsigned char* data = stbi_load("C:/Users/josec/Desktop/2024 Projects/C&C++/Breakout/resources/container.jpg", &width, &height, &nrChannels, 0);
    //if (data)
    //{
    ...
    // glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
    // load image, create texture and generate mipmaps
    // data = stbi_load("C:/Users/josec/Desktop/2024 Projects/C&C++/Breakout/resources/awesomeface.png", &width, &height, &nrChannels, 0);
    // if (data)
    // {
